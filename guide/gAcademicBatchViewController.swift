//
//  gAcademicBatchViewController.swift
//  trackPro
//
...
import UIKit
protocol getval_spl17
{
    func getsdata(selected:String)
}
class gAcademicBatchViewController: UIViewController,UITableViewDataSource,UITableViewDelegate ,UIPopoverPresentationControllerDelegate{
    var arr = ["Apple","Chicku","Straberry","Grapes","Tomato"]
    //  let varForProto:testproto?
      var delegate : getval_spl17?
