//
//  gAcademicUsnViewController.swift
//  trackPro
//
...
//
import UIKit
protocol getval_spl18
{
    func getsdata1(selected:String)
}
class gAcademicUsnViewController: UIViewController,UITableViewDataSource,UITableViewDelegate ,UIPopoverPresentationControllerDelegate{
    var arr = ["Apple","Chicku","Straberry","Grapes","Tomato"]
    //  let varForProto:testproto?
      var delegate : getval_spl18?
