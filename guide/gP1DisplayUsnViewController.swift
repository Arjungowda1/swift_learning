import UIKit
protocol getval_spl29
{
    func getsdata(selected:String)
}
class gP1DisplayUsnViewController: UIViewController,UITableViewDataSource,UITableViewDelegate ,UIPopoverPresentationControllerDelegate{
    var arr = ["Apple","Chicku","Straberry","Grapes","Tomato"]
    //  let varForProto:testproto?
      var delegate : getval_spl29?
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return arr.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellm",for: indexPath)
