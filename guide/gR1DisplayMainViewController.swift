import UIKit
import FirebaseAuth
class gR1DisplayMainViewController: UIViewController,UIPopoverPresentationControllerDelegate,getval_spl_g,getval_spl_g2 {
    func getSelectedBatch(selectedBatch: String) {
     gR1Batch.setTitle(selectedBatch, for: .normal)
    ...
    func getSelectedUsn(selectedUsn: String) {
            currUsn = selectedUsn
            gR1Usn.setTitle(selectedUsn, for: .normal)
    ...
    @IBOutlet var gR1Batch: UIButton!
    @IBOutlet var gR1Usn: UIButton!
    ...
    @IBAction func gR1BatchFunc(_ sender: UIButton) {
    ...
    @IBAction func gR1UsnFunc(_ sender: UIButton) {
    ...
    func fetchReview1marks(){
     fetchDetails().getGuideReview1Marks { (marksData, error) in
