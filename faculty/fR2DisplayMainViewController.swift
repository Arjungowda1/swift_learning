//
//  fR2DisplayMainViewController.swift
//  trackPro
//
...
import UIKit
import FirebaseAuth
class fR2DisplayMainViewController: UIViewController,UIPopoverPresentationControllerDelegate,getval_spl_f,getval_spl_f2,getval_spl_f3 {
    func getSelectedSection(selectedSection: String){
        print("Reaching..")
        curSection = selectedSection
        fR2DisplaySection.setTitle(selectedSection, for: .normal)
        
        fetchSectionData()
    }
    func getSelectedBatch(selectedBatch: String) {
       curSection = selectedBatch
        fR2DisplayBatch.setTitle(selectedBatch, for: .normal)
    ...
    func getSelectedUsn(selectedUsn: String) {
           currUsn = selectedUsn
           fR2DisplayUsn.setTitle(selectedUsn, for: .normal)
    ...
    @IBOutlet weak var fR2DisplaySection: UIButton!
    @IBOutlet weak var fR2DisplayBatch: UIButton!
    @IBOutlet weak var fR2DisplayUsn: UIButton!
    ...
    @IBAction func fR2DisplaySection(_ sender: UIButton) {
    ...
    @IBAction func fR2DisplayBatchFunc(_ sender: UIButton) {
    ...
    @IBAction func fR2DisplayUsnFunc(_ sender: UIButton) {
    ...
    func fetchBatchData()
       ...
       func fetchReview2marks(){
          fetchDetails().getFacultyReview2Marks { (marksData, error) in
