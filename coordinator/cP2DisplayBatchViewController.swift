//
//  cP2DisplayBatchViewController.swift
//  trackPro
//
...
import UIKit
protocol getval_spl13
{
    func getsdata(selected:String)
}
class cP2DisplayBatchViewController: UIViewController,UITableViewDataSource,UITableViewDelegate ,UIPopoverPresentationControllerDelegate {
    var arr = ["Apple","Chicku","Straberry","Grapes","Tomato"]
    //  let varForProto:testproto?
      var delegate : getval_spl13?
