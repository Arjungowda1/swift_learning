//
//  cP2MainDisplayViewController.swift
//  trackPro
//
...
import UIKit
import FirebaseAuth
class cP2MainDisplayViewController: UIViewController,UIPopoverPresentationControllerDelegate,getval_spl,getval_spl2 {

           func getSelectedBatch(selectedBatch: String) {
        cP2DisplayBatch.setTitle(selectedBatch, for: .normal)
    ...
    func getSelectedUsn(selectedUsn: String) {
           currUsn = selectedUsn
           cP2DisplayUsn.setTitle(selectedUsn, for: .normal)
    ...
    @IBOutlet var cP2DisplayBatch: UIButton!
    @IBOutlet var cP2DisplayUsn: UIButton!
    ...
    @IBAction func cP2DisplayBatchFunc(_ sender: UIButton) {
    ...
    @IBAction func cP2DisplayUsnFunc(_ sender: UIButton) {
    ...
    func fetchBatchData()
          {
           ...
           func fetchPhase2marks(){
                fetchDetails().getCoordPhase2Marks{ (marksData, error) in
