//
//  cR2AddBatchViewController.swift
//  trackPro
//
...
import UIKit
protocol getval_spl7
{
    func getsdata(selected:String)
}
class cR2AddBatchViewController: UIViewController,UITableViewDataSource,UITableViewDelegate
,UIPopoverPresentationControllerDelegate{
     var arr = ["Apple","Chicku","Straberry","Grapes","Tomato"]
        //  let varForProto:testproto?
          var delegate : getval_spl7?
