...
import UIKit
protocol getval_spl12
{
    func getsdata2(selected:String)
}
class cP1AddUsnViewController: UIViewController,UITableViewDelegate,UITableViewDataSource ,UIPopoverPresentationControllerDelegate {
    var arr = ["Apple","Chicku","Straberry","Grapes","Tomato"]
    var delegate : getval_spl12?
