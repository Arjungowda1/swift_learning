//
//  cR1AddBatchViewController.swift
//  trackPro
//
...
import UIKit
protocol getval_spl3
{
    func getSelectedBatch(selectedBatch:String)
}
class cR1AddBatchViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UIPopoverPresentationControllerDelegate {
   var batchArray:[batchDetails] = []
    var delegate : getval_spl3?
