//
//  cR2MainDisplayViewController.swift
//  trackPro
//
...
class cR2MainDisplayViewController: UIViewController,UIPopoverPresentationControllerDelegate,getval_spl,getval_spl2 {

    
    func getSelectedBatch(selectedBatch: String) {
           cR2DisplayBatch.setTitle(selectedBatch, for: .normal)
       ...
       func getSelectedUsn(selectedUsn: String) {
              currUsn = selectedUsn
              cR2DisplayUsn.setTitle(selectedUsn, for: .normal)
    ...
    @IBOutlet var cR2DisplayBatch: UIButton!
    
    
    @IBOutlet var cR2DisplayUsn: UIButton!
   

    @IBAction func cR2DisplayBatchFunc(_ sender: UIButton) {
    ...
    @IBAction func cR2DisplayUsnFunc(_ sender: UIButton) {
   ...
   func fetchReview2marks(){
      fetchDetails().getCoordReview2Marks { (marksData, error) in
